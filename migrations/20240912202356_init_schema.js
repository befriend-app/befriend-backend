    ...
    return knex.schema
        ...
        .createTable('persons', (table) => {
            ...
            table
                ...
                .notNullable()
                .defaultTo(0)
                .comment('Aggregated from persons_reviews');
            table
                .float('reviews_rating', 5, 3)
                .notNullable()
                .comment('Aggregated from persons_reviews');
        ...
        .createTable('activities', (table) => {
            ...
            table
                ...
                .unsigned()
                .notNullable()
                .comment('Person that created the activity');
            ...
            table
                ...
                .notNullable()
                .comment('Unix timestamp of approximate activity start time');
            table
                .integer('activity_duration_min')
                .notNullable()
                .comment('Approximate duration of activity in minutes');
            table.boolean('no_end_time').notNullable().defaultTo(false);
            table.integer('number_persons').notNullable();
            table
                .bigInteger('is_public')
                .notNullable()
                .defaultTo(1)
                .comment('Whether location selected is a public setting.');
        ...
        .createTable('filters', (table) => {
            ...
            table
                ...
                .notNullable()
                .defaultTo(false)
                .comment('Linked to persons birth_date');
        ...
        .createTable('activities_filters', (table) => {
            ...
            table
                ...
                .defaultTo(false)
                .comment(
                    'If a person does not want to use a particular filter in their settings for a particular activity.',
                );
        ...
        .createTable('activities_persons', (table) => {
            ...
            table
                ...
                .defaultTo(0)
                .comment(
                    'If person cancels, system would try to fill remaining number_persons based on current time and start of activity',
                );
        ...
        .createTable('persons_filters', (table) => {
            ...
            table
                ...
                .defaultTo(false)
                .comment(
                    "Example: If a person is a Chicago Cubs fan, and they put is_negative for New York Mets, notifications won't be sent out to anybody who added New York Mets as an interest.",
                );
        ...
        .createTable('persons_friends', (table) => {
            ...
            table
                ...
                .notNullable()
                .defaultTo(false)
                .comment('Helper column for code.');
            table
                .string('source', 255)
                .nullable()
                .comment('Source of where friend came from (i.e. befriend, phone, email, etc)');
