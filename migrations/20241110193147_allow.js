...
exports.up = function (knex) {
    return knex.schema.alterTable('open_cities', (table) => {
        table.decimal('bbox_lat_min', 8, 4).nullable().alter();
        table.decimal('bbox_lat_max', 8, 4).nullable().alter();

        table.decimal('bbox_lon_min', 8, 4).nullable().alter();
        table.decimal('bbox_lon_max', 8, 4).nullable().alter();
